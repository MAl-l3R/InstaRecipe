package com.example.instarecipe.ui.favoritesPage;
...
public class FavoritesFragment extends Fragment implements RecyclerViewInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        goLikeMessage = view.findViewById(R.id.go_like_recipes);

        // Set up the recycler view
        recyclerView = view.findViewById(R.id.recipes_list_fav);
        ...
        Database.getLikedRecipes(currentUser.getUid(),
                new OnSuccessListener<ArrayList<Recipe>>() {
                    ...
                    public void onSuccess(ArrayList<Recipe> recipeArrayList) {
                        ...
                        // Show go like recipes message if user does not have any favorite recipes
                        if (recipeList.isEmpty()) {
                            goLikeMessage.setVisibility(View.VISIBLE);
